...
if(!$total=$reg8log_db->result_num($query)) {
	...
	my_exit('<center><h3>'.func::tr('No IP block log records found.').'</h3><a href="index.php">'.func::tr('Admin operations').'</a><br><br><a href="../index.php">'.func::tr('Login page').'</a></center>');
}
