...
require_once 'include/code/code_fetch_site_vars.php';
...
require 'include/code/code_generate_unique_random_id.php';
...
require 'include/code/code_email_password_reset_link.php';
...
if(isset($cleanup)) {
	require 'include/info/info_cleanup.php';
	if(mt_rand(1, floor(1/$cleanup_probability))==1) require 'include/code/code_password_reset_expired_cleanup.php';
}
...
require 'include/page/page_password_reset_request_form.php';
