...
$admin_operations_require_password=30;//whether entering admin password is required when performing admin operations (such as confirming or deleting an account).
