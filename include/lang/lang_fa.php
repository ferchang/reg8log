...
'Check your email carefully msg' => 'ایمیل خود را به دقت چک کنید چون، به دلایل امنیتی، سیستم به شما نخواهد گفت که ایمیلی که وارد کرده اید واقعا در پایگاه داده‌ها وجود دارد یا خیر؛<br>بدیهی است که اگر شما مرتکب یک خطای تایپی شده یا دقیقا بیاد ندارید کدامیک از ایمیل های خودتان را برای اکانت خود تعیین کرده بودید، میتوانید مجدداً تلاش کنید.',
'Check your email carefully msg2' => 'ایمیل خود را به دقت چک کنید چون، به دلایل امنیتی، سیستم به شما نخواهد گفت که ایمیلی که وارد کرده اید با ایمیل اکانت مسدود شده شده یکسان است یا خیر؛<br>بدیهی است که اگر شما مرتکب یک خطای تایپی شده یا دقیقا بیاد ندارید کدامیک از ایمیل های خودتان را برای اکانت مسدود شده تعیین کرده بودید، میتوانید مجدداً تلاش کنید.',
