...
return array(
'Unban selected accounts' => 'اکانتهای انتخاب شده را رفع محرومیت کن',
'unban2' => 'لغو محرومیت',
...
'debug mode turn off instruction msg' => 'برای خاموش کردن حالت عیب یابی، مقدار متغییر debug_mode در فایل config_common.php را به false تغییر دهید',
...
'Error log file not writable!' => 'فایل گزارش خطا قابل نوشتن نیست!',
'Error log directory not writable!' => 'دایرکتوری فایل گزارش خطا قابل نوشتن نیست!',
