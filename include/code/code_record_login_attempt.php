...
if(isset($identified_user) or isset($pending_user) or isset($banned_user)) {
	...
	if($ip_lockdown_threshold!=-1 and $count+1>=$ip_lockdown_threshold and (($dont_block_admin_account!=2 and $dont_block_admin_account!=3) or strtolower($manual_identify['username'])!=='admin')) {
