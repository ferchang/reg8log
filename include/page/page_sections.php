...
<a href="', $index_dir, 'change_lang.php?antixsrf_token=', $_SESSION['reg8log']['reg8log_antixsrf_token4get'], '" onclick="this.href=this.href+\'&addr=\'+location.href">', func::tr('Change language'), '</a><br>
