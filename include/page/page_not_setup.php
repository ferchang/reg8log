...
<br><br><a href="<?php echo $index_dir; ?>change_lang.php?setup&antixsrf_token=<?php echo $_SESSION['reg8log']['antixsrf_token4get']; ?>" onclick="this.href=this.href+'&addr='+location.href"><?php echo func::tr('Change language'); ?></a>
</small></h3>
</td></tr></table>
<?php
