...
<br><br><a href="<?php echo $index_dir; ?>change_lang.php?antixsrf_token=<?php echo ANTIXSRF_TOKEN4GET; ?>" onclick="this.href=this.href+'&addr='+location.href"><?php echo func::tr('Change language'); ?></a>
</small></h3>
</td></tr></table>
<?php
