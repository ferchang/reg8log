...
<title><?php echo func::tr('Change email'); ?></title>
<style>
</style>
...
if(!document.change_email_form.password.value) msgs[i++]='<?php echo func::tr('Password field is empty!'); ?>';

newemail_value=document.change_email_form.newemail.value;
reemail_value=document.change_email_form.reemail.value;

if(newemail_value.length<min_length) msgs[i++]=<?php echo func::tr('New email is shorter than'); ?>
else if(newemail_value.length>max_length) msgs[i++]=<?php echo func::tr('New email is longer than'); ?>
else if(re && newemail_value && !re.test(newemail_value)) msgs[i++]="<?php echo func::tr('New email is invalid!'); ?>";
else if(newemail_value!=reemail_value) msgs[i++]='<?php echo func::tr('New email fields are not match!'); ?>';
...
?>
<tr>
<td <?php echo CELL_ALIGN; ?>><?php echo func::tr('Your account Password'); ?>:</td><td><input type="password" name="password" size="30" style="width: 100%"  autocomplete="off" /></td>
</tr>
<tr>
<td <?php echo CELL_ALIGN; ?>><?php echo func::tr('New email'); ?>:</td><td><input type="text" name="newemail" size="30" style="width: 100%" <?php if(isset($_POST['newemail'])) echo 'value="', htmlspecialchars($_POST['newemail'], ENT_QUOTES, 'UTF-8'), '"'; ?>></td>
</tr>
<tr>
<td <?php echo CELL_ALIGN; ?>><?php echo func::tr('Retype new email'); ?>:</td><td><input type="text" name="reemail" size="30" style="width: 100%" <?php if(isset($_POST['reemail'])) echo 'value="', htmlspecialchars($_POST['reemail'], ENT_QUOTES, 'UTF-8'), '"'; ?>></td>
</tr>
<?php
