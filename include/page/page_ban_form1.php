...
if(!ban_form.user.value.length) msgs[i++]="user field is empty!";
...
<h4 style="margin-bottom: 3px">Specify username or uid:</h4>
...
<tr>
<td align="center">
<input type="reset" value="Clear" onClick="return clear_form();" tabindex="100" />
