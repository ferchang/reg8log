...
if(!$rec['banned'] or ($rec['banned']!=1 and $rec['banned']<$req_time)) echo '<h3>User <span style="color: yellow">', htmlspecialchars($rec['username'], ENT_QUOTES, 'UTF-8'), '</span> is not banned!</h3>';
else {
...
if($ban_until!=1) {
	require_once $index_dir.'include/func/func_duration2friendly_str.php';
	echo 'Ban until:  <span style="color: #8fd;">', duration2friendly_str($ban_until-$req_time, 2), '</span> later.';
}
