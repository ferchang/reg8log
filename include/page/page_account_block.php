...
if($block_bypass_system_enabled==3 or ($block_bypass_system_enabled==1 and strtolower($_POST['username'])=='admin') or ($block_bypass_system_enabled==2 and strtolower($_POST['username'])!='admin')) {
?>
