...
$query="select * from `accounts` where `username`=".$GLOBALS['reg8log_db']->quote_smart($identified_user).' limit 1';
...
if($identified_user!=='Admin') if($rec['banned']==1 or $rec['banned']>REQUEST_TIME) echo '<td>', func::tr('Yes'), '</td>';
